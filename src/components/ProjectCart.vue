    ...
    <div>
      <div class="w-full shadow-xl rounded-[20px] overflow-hidden">
        ...
        <div class="p-[27px]">
          ...
          <p class="text-[14px] font-light text-[#42446e] mb-[21px]">
            <span class="text-[16px] font-normal">Tech stack:</span>
            {{ web.stack }}
          </p>
          <div class="flex gap-[48px] items-center">
            <a class="flex items-center" target="_blank" :href="web.link">
              <svg class="inline-block mr-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
                <path
            ...
            <a class="flex items-center" target="_blank" :href="web.github">
              <svg class="inline-block mr-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
