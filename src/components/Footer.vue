  ...
  <div class="pb-6 mt-12 md:mt-[100px]">
    <div class="border-b pb-6 flex justify-between items-center mb-5">
      ...
      <div class="flex gap-3 sm:gap-[45px] items-center flex-wrap">
        ...
        <div class="flex gap-5 items-center">
          <a class="social-link w-[40px] hover:-translate-y-2" href="https://t.me/kn6429">
          ...
          <a class="social-link w-[40px] hover:-translate-y-2" href="https://github.com/ideapadkn" target="_blank">
          ...
          <a class="social-link w-[40px] hover:-translate-y-2" href="https://www.linkedin.com/in/ideapadkn/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
              <path fill="#0288D1"
    ...
    <div class="flex justify-center items-center">
      <p class="text-[16px] sm:text-lg text-[#666]">
        Developed by <span>Karimov Kamron</span> &copy; 2023
      </p>
    </div>
  </div>
</template>
